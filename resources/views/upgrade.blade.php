<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-3xl text-blue-800 dark:text-blue-300 leading-tight">
                ...
                <div class="p-8">
                    ...
                    <div class="grid md:grid-cols-2 gap-8 mb-8">
                        <div class="bg-blue-50 dark:bg-blue-900 p-6 rounded-lg">
                            <h4 class="text-xl font-semibold text-blue-800 dark:text-blue-300 mb-3">What You Get:</h4>
                            <ul class="space-y-2">
                                <li class="flex items-center">
                                    ...
                                    <span class="text-gray-700 dark:text-gray-300">Unlimited transcriptions</span>
                                </li>
                                <li class="flex items-center">
                                    <svg class="h-5 w-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                                    <span class="text-gray-700 dark:text-gray-300">No daily limits</span>
                                </li>
                                <li class="flex items-center">
                                    <svg class="h-5 w-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                                    <span class="text-gray-700 dark:text-gray-300">Priority processing</span>
                                </li>
                                <li class="flex items-center">
                                    <svg class="h-5 w-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                            <h4 class="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">Why Upgrade?</h4>
                            <ul class="space-y-2">
                                <li class="flex items-start">
                                    ...
                                    <span class="text-gray-700 dark:text-gray-300">Boost productivity with unlimited access</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="h-5 w-5 text-blue-500 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                                    <span class="text-gray-700 dark:text-gray-300">Remove Vocaldo Watermark</span>
                                </li>
                                <li class="flex items-start">
                                    ...
                                    <span class="text-gray-700 dark:text-gray-300">Save time with faster processing</span>
                                </li>
                                <li class="flex items-start">
                                    ...
                                    <span class="text-gray-700 dark:text-gray-300">Ensure data security and confidentiality</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        <p class="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-6">One-time payment of just $29 for lifetime access!</p>
                    ...
                    <!-- Social Proof 
                    <div class="mt-12">
                        <h4 class="text-xl font-semibold text-center mb-4 text-gray-800 dark:text-gray-200">Trusted by Industry Leaders</h4>
                        <div class="flex justify-center space-x-8">
                            <img src="{{ asset('img/company-logo-1.png') }}" alt="Company 1" class="h-8 dark:filter dark:invert">
                            <img src="{{ asset('img/company-logo-2.png') }}" alt="Company 2" class="h-8 dark:filter dark:invert">
                            <img src="{{ asset('img/company-logo-3.png') }}" alt="Company 3" class="h-8 dark:filter dark:invert">
                        </div>
                    </div> -->

                    <!-- Testimonial 
                    <div class="mt-12 bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                        <p class="text-lg italic text-gray-700 dark:text-gray-300">"Vocaldo's unlimited plan has revolutionized our workflow. We've increased our productivity by 300% since upgrading!"</p>
                        <p class="mt-2 font-semibold text-gray-900 dark:text-gray-100">- John Doe, CEO of TechCorp</p>
                    </div> -->
                </div>
            </div>
        </div>
