    ...
    <main>
        <section class="py-20 bg-blue-600 text-white">
            <div class="container mx-auto px-4 text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">AI-Powered SRT Transcription</h1>
                <p class="text-xl mb-8">Generate accurate, time-stamped subtitles with our cutting-edge AI technology</p>
                <a href="#" class="bg-white text-blue-600 px-8 py-3 rounded-full font-bold hover:bg-blue-100 transition">Try SRT Transcription Free</a>
            </div>
        </section>

        <section id="features" class="py-20">
            <div class="container mx-auto px-4">
                <h2 class="text-3xl font-bold text-center mb-12">Why Choose Our SRT Transcription AI?</h2>
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <h3 class="text-xl font-semibold mb-4">Unmatched Accuracy</h3>
                        <p>Our AI transcription engine delivers industry-leading accuracy, ensuring your SRT files are precise and reliable.</p>
                    </div>
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <h3 class="text-xl font-semibold mb-4">Lightning-Fast Processing</h3>
                        <p>Get your SRT files in minutes, not hours. Our AI works at unprecedented speeds to deliver quick results.</p>
                    </div>
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <h3 class="text-xl font-semibold mb-4">Multi-Language Support</h3>
                        <p>Generate SRT files in over 100 languages, making your content accessible to a global audience.</p>
                    </div>
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <h3 class="text-xl font-semibold mb-4">Perfect Timing</h3>
                        <p>Our AI ensures precise time-stamping, synchronizing your subtitles perfectly with your video content.</p>
                    </div>
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <h3 class="text-xl font-semibold mb-4">Easy Integration</h3>
                        <p>Seamlessly integrate our SRT files with popular video platforms and editing software.</p>
                    </div>
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <h3 class="text-xl font-semibold mb-4">Customization Options</h3>
                        <p>Adjust timing, edit text, and format your SRT files to match your specific requirements.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-20 bg-gray-100">
            <div class="container mx-auto px-4">
                <h2 class="text-3xl font-bold text-center mb-12">How Our SRT Transcription AI Works</h2>
                <div class="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-12">
                    ...
                    <div class="text-center">
                        ...
                        <p>Our AI transcribes and time-stamps</p>
                    </div>
                    <div class="text-center">
                        ...
                        <p>Get your SRT file instantly</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="pricing" class="py-20">
            <div class="container mx-auto px-4">
                <h2 class="text-3xl font-bold text-center mb-12">Affordable SRT Transcription Plans</h2>
        ...
        <section class="py-20 bg-blue-600 text-white">
            <div class="container mx-auto px-4 text-center">
                <h2 class="text-3xl font-bold mb-8">Ready to Transform Your Videos with AI-Powered SRT Transcription?</h2>
