...
@auth
        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                    ...
                    <x-nav-link :href="route('audio_files.create')" :active="request()->routeIs('audio_files.create')" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 transition duration-150 ease-in-out">
                        {{ __('Transcribe') }}
                    </x-nav-link>
                </div>
            </div>
   ...
   <!-- Dark Mode Toggle -->
   <button id="darkModeToggle" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('audio_files.index')" :active="request()->routeIs('audio_files.index')">
                {{ __('History') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('audio_files.create')" :active="request()->routeIs('audio_files.create')">
                {{ __('Transcribe') }}
            </x-responsive-nav-link>
        </div>
